// src/features/eventos/components/EventoShareButtons.tsx
"use client"
...
interface EventoShareButtonsProps {
  titulo: string
  descripcion: string
}
...
export function EventoShareButtons({ titulo, descripcion }: EventoShareButtonsProps) {
  ...
  return (
    <div className="p-6 border rounded-2xl bg-card/80 backdrop-blur-sm border-border/50 shadow-lg space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-bold text-foreground">Compartir evento</h3>
      </div>
