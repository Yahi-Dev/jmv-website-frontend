          ...
          <Reveal delay={150} y={28}>
            <div>
              <Serif size={44} weight={300} style={{ lineHeight: 1.2 }}>
                Formamos jóvenes líderes cristianos comprometidos con la fe, el servicio y la comunidad, al estilo de <span style={{ fontStyle: "italic", color: JMV.gold }}>María</span> y <span style={{ fontStyle: "italic", color: JMV.celeste }}>San&nbsp;Vicente de&nbsp;Paúl</span>.
              </Serif>
